...
const Home: React.FC = () => {
  ...
  // Fetch products dynamically using RTK Query from the API
  ...
  const handleLoadMore = () => {
    // Increment limit to load more products from the API
    ...
    <div>
      ...
      <main className="home-main">
        ...
        <div className="home-container">
          ...
          {/* Load More Button - Fetches additional items from the API */}
